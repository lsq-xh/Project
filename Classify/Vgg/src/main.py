...
def main():
    ...
    training_log_dir = r"E:/Code_Py/Vgg/train_log/"
    test_image_dir = r"E:/Code_Py/Vgg/test_image/"
    model_save_dir = r"E:/Code_Py/Vgg/model_save/"
    ...
    model = VGG(number_of_classes=datasets.get_object_class_and_number()[0], image_shape=image_shape).vgg_net()

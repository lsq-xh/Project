...
def main():
    ...
    training_log_dir = r"E:/Code_Py/LeNet/train_log/"
    test_image_dir = r"E:/Code_Py/LeNet/test_image/"
    model_save_dir = r"E:/Code_Py/LeNet/model_save/"
    ...
    model = Le(number_of_classes=datasets.get_object_class_and_number()[0], image_shape=image_shape).le_net()

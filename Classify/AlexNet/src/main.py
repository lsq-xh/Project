...
def main():
    ...
    training_log_dir = r"E:/Code_Py/AlexNet/train_log/"
    test_image_dir = r"E:/Code_Py/AlexNet/test_image/"
    model_save_dir = r"E:/Code_Py/AlexNet/model_save/"
    ...
    model = Alex(number_of_classes=datasets.get_object_class_and_number()[0], image_shape=image_shape).alex_net()
    print("---", model)
